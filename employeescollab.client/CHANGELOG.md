...
- Create Angular project with ng: `ng new employeescollab.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`employeescollab.client.esproj`).
